...
/**
 * La clase GestionFBinario se encarga de gestionar el archivo binario de almacenamiento para guardar y cargar el estado
...
public class GestionFBinario implements Serializable {
    ...
    /**
     * Devuelve la instancia única de GestionFBinario.
     *
     * @return instancia de GestionFBinario
     */
    ...
    /**
     * Carga la partida guardada desde el archivo binario y devuelve la instancia de la clase Granja.
     * Si ocurre un error al cargar el archivo, devuelve null.
     *
     * @return la instancia de Granja cargada desde el archivo, o null si no se pudo cargar.
     * @throws IOException si hay un problema con la entrada/salida al leer el archivo
     * @throws ClassNotFoundException si el archivo no contiene una clase Granja
     */
    public Granja cargarPartidaGuardada() {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(RUTA_FICHERO_BINARIO))) {
            ...
            Tienda.getInstancia().generarNuevaTienda(granja.getEstacion());
     ...
     *
     * @param granja instancia de Granja que representa el estado actual de la partida
